...
<div style="top: 10em ! important;" class="main" id="main">
    ...
    <div class="booking-form-head-agile">
        <h3 style="color: #524747">Upcoming Events</h3>
    </div>
    ...
    <div class="container">
        <div class="w3-agile-about-grids">
            ...
            <?php
                $listOfUpcomingEvents = getListOfAllUpcomingEvents();
                $alphaOrder = array();

                foreach ($listOfUpcomingEvents as $key => $event) {
                            ...
                            <div style=\"margin-left: 80px;\" >
                                ...
                                <div class=\"pricing-text\">";
                                    ...
                                    foreach ($alpha as $items) {
                                        echo "
                                            <div><a href='event_detail.php?event_id=".$items['id']."' style='all: unset; color:#168eea'>".$items['content']."</a></div>
                                        ";
                                    }
